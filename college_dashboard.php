    ...
    <div class="row h-100" style="height: 100%;">
      <div class="col-sm-2">
        <ul class="nav nav-pills nav-stacked navbar-dark" style="text-align: center; background-color:blanchedalmond;padding: 30px;">
            <li><a onclick="go('clg_profile.php')" class="focus">My Profile</a></li>
            <li><a onclick="go('validate.php')">Validate Alumini</a></li>
            <li><a onclick="go('add_event.php')"> Add Events</a></li>
            <li><a onclick="go('add_clg_notice.php')"> Add Notices</a></li>
            <li><a href="#" onclick="go('clg_email.php')">Send Emails</a></li>
            <li><a onclick="go('search.php')">Search</a></li>
        </ul>
      </div>
    
        <div class="col-sm-10 h-100" style="margin-top:0%;height: 1000% ">
                <iframe id="iframe_a" style="width:100%;height: 370px;outline: none;"  src="about:blank">
                    </iframe>
      </div>
      </div>
      </div>
...
<!-- Footer -->
  ...
  <script>
      document.getElementById('iframe_a').src = "clg_profile.php";
        function go(loc) {
